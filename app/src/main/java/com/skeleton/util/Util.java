...
public final class Util {
    ...
    private static final int ONE_MIN_MILI = 60000;
    ...
    /**
     * @param resourceId String Array resource Id
     * @return List Of String from resource id
     */
    public static List<String> getListFromArrayResource(final int resourceId) {
        return Arrays.asList(MyApplication.getAppContext()
