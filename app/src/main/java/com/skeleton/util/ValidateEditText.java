...
import static com.skeleton.constant.AppConstant.REGEX_MOBILE_NUMBER;
...
public final class ValidateEditText {
    ...
    public static boolean checkPhoneNumber(final EditText et) {
        ...
        return et.getText().toString().trim().matches(REGEX_MOBILE_NUMBER)
     ...
     */
    public static boolean checkEditTextWithError(final AppCompatEditText editText, final String error) {
