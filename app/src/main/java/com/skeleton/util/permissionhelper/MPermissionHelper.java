...
public final class MPermissionHelper {
     ...
     *                    ActivityCompat.OnRequestPermissionsResultCallback} or override
     *                    {@link Fragment.onRequestPermissionsResult(int, String[], int[])} if
     *                    it extends from {@link Fragment}.
     ...
     *                       Fragment#onRequestPermissionsResult(int, String[], int[])} if
     *                       it extends from {@link Fragment}.
     * @param rationale      a message explaining why the application needs this set of permissions,
     *                       will be displayed if the user rejects the request the first time.
